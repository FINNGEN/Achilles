-- 1844	Number of persons with at least one measurement occurrence, by measurement_source_concept_id by calendar year by gender by age decile

--HINT DISTRIBUTE_ON_KEY(stratum_1)
WITH rawData AS (
SELECT 
	m.measurement_source_concept_id AS stratum_1,
...
SELECT
	...
	count_value
INTO 
	@scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_1844
FROM 
	rawData;
