-- 744	Number of persons with at least one drug occurrence, by drug_source_concept_id by calendar year by gender by age decile

--HINT DISTRIBUTE_ON_KEY(stratum_1)
WITH rawData AS (
SELECT 
	de.drug_source_concept_id AS stratum_1,
...
SELECT
	...
	count_value
INTO 
	@scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_744
FROM 
	rawData;
