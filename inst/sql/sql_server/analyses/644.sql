-- 644	Number of persons with at least one procedure occurrence, by procedure_source_concept_id by calendar year by gender by age decile

--HINT DISTRIBUTE_ON_KEY(stratum_1)
WITH rawData AS (
SELECT 
	po.procedure_source_concept_id AS stratum_1,
...
SELECT
	...
	count_value
INTO 
	@scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_644
FROM 
	rawData;
